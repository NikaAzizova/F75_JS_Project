...
/*export  const btnInfo = document.getElementById("info__btn");
export  const modal = document.getElementById("modal");
export const btnClose = document.getElementsByClassName("modal__close")[0];
export  const confirmForm= document.forms.confirmForm;
